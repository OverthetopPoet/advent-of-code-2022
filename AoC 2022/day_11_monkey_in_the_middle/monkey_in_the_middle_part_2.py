...
class Monkey:
    ...
    def take_turn(self):
        ...
        for i in range(nr_items):
            ...
            self.item_list[0] = self.reduce_worry(self.item_list[0])
            self.throw()
    ...
    def reduce_worry(self, worry_level):
        # not my solution found on the internet because I'm shit at maths
        # credits https://www.reddit.com/user/_smallconfusion/
        # Link https://www.reddit.com/r/adventofcode/comments/zih7gf/comment/izr79go/?context=3 explanation in following comments
        supermodulo = 1

        for monkey in self.monkey_list:
            monkey_divider = monkey.get_divider()
            supermodulo *= monkey_divider
